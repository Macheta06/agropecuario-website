    ...
    <div className="animate-fade-in">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 grid md:grid-cols-3 gap-8 text-center">
        <div className="product-card p-8 flex flex-col items-center">
          ...
          <p className="text-zinc-500">Calle Principal #12-34<br/>Machetá, Cundinamarca</p>
        </div>
        ...
        <div className="product-card p-8 flex flex-col items-center">
          ...
          <p className="text-zinc-500">Lun - Sáb: 7:00 AM - 6:00 PM<br/>Dom: 8:00 AM - 1:00 PM</p>
        </div>
        ...
        <div className="product-card p-8 flex flex-col items-center">
          ...
          <p className="text-zinc-500">Cel: +57 300 000 0000<br/>Ventas y pedidos mayoristas</p>
        </div>
      </section>
